...
public class Appointment extends ResponseDTO {
	...
	public BookingOrg getBookingOrganization() {
		return bookingOrg;
	}
	...
	public void setBookingOrganization(BookingOrg bookingOrganization) {
		this.bookingOrg = bookingOrganization;
	}
